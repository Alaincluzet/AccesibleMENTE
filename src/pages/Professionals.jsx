...
const specialties = [
  'Todas', 'Psiquiatría', 'Psicología',
  'Psicopedagogía', 'Psicología infantil', 'Terapia de pareja',
]
...
const professionals = [
  {
    ...
    price: 500,
    image: 'https://i.pinimg.com/736x/b8/68/20/b86820c5296cfd042edf7d72dc9e579a.jpg',
    ...
    therapyTypes: ['Psiquiatría clínica', 'Ansiedad', 'Depresión', 'Seguimiento farmacológico', 'Autoestima', 'Adicciones', 'Fortalecimiento de vínculos',],
  },
  {
    ...
    price: 400,
    image: 'https://i.pinimg.com/736x/e5/8b/93/e58b93a5044f1779dbb6ae50d251d0b3.jpg',
  ...
  },
  {
    ...
    price: 450,
    image: 'https://i.pinimg.com/1200x/ac/f4/8c/acf48c8411b1257725a1af63150091ea.jpg',
    ...
    therapyTypes: ['Psicopedagogía', 'Aprendizaje', 'Orientación familiar', 'Técnicas de estudio'],
  },
  {
    ...
    price: 350,
    image: 'https://i.pinimg.com/1200x/f7/70/c7/f770c7c8d3041bade2bf9e96efb974a8.jpg',
    ...
    therapyTypes: ['Infancias', 'Juego terapéutico', 'Vínculos familiares', 'Conducta', 'Estrés', 'Comunicacion', 'Confianza',],
  },
  {
    ...
    price: 500,
    image: 'https://i.pinimg.com/736x/f6/ed/5c/f6ed5c531dfd847de6b965dc56dbb62a.jpg',
    ...
    therapyTypes: ['Terapia de pareja', 'Comunicación', 'Acuerdos', 'Crisis vincular', 'Habitos Saludables', 'Fortalecimiento de relaciones',],
  },
  {
    ...
    price: 450,
    image: 'https://i.pinimg.com/736x/7e/4f/f7/7e4ff7f31a18bc9ff19e49bb4183339b.jpg',
    ...
    therapyTypes: ['Psiquiatría', 'Adolescencia', 'Regulación emocional', 'Acompañamiento clínico' , 'Terapia de Pareja'],
  },
  {
    ...
    focus: 'Salud mental perinatal y regulación emocional',
    price: 400,
    image: 'https://i.pinimg.com/1200x/d1/87/43/d18743c1adc725dc29bc4f93b9637853.jpg',
    ...
    therapyTypes: [ 'Terapia familiar', 'Evaluación psiquiátrica', 'Estrés', 'Seguimiento clinico', 'Salud integral'],
  },
  {
    ...
    focus: 'Salud mental perinatal y regulación emocional',
    price: 500,
    image: 'https://i.pinimg.com/1200x/ab/ae/8f/abae8f30ed7e9b4b650e02ff689e5395.jpg',
    ...
    therapyTypes: ['Psicoterapia', 'traumas', 'Ansiedad', 'Duelo', 'Cambios vitales', 'Depresion', 'Trastornos alimentarios' ],
  },
  {
    ...
    focus: 'Dificultades de aprendizaje y orientación escolar',
    price: 300,
    image: 'https://i.pinimg.com/736x/74/5d/6e/745d6e90aa416d4f75d079e9ef874d63.jpg',
    ...
    therapyTypes: ['Psicopedagogía', 'Hábitos de estudio', 'Motivación', 'Acompañamiento escolar', 'Guia Escolar' , 'Desarrollo emocional y conductual de niños'],
  },
]
...
function Professionals() {
  ...
  // modal solo con el boton sino no 
    ...
    <section className="mh-section" aria-labelledby="mh-services-title">
      <div className="mh-layout">
        ...
        <aside className="mh-sidebar">
          <div>
            ...
            <h2 className="mh-sidebar-title text-center">Elige la especialidad que buscas</h2>
          </div>
          <div className="mh-chip-list" role="list">{specialties.map((sp) => 
          (
              <button
                key={sp}
                type="button"
                className={`mh-chip${selectedSpecialty === sp ? ' mh-chip--active' : ''}`}
                onClick={() => setSelectedSpecialty(sp)}>{sp}</button>
            ))}
          ...
          <div className="mh-price-filter">
            ...
            <p className="mh-price-value">Hasta ${maxPrice.toLocaleString('es-UY')}</p>
            <input
              type="range"
              className="mh-range"
              min={MIN_PRICE}
        ...
        <article className="mh-carousel">
          ...
          <div className="mh-carousel-content">
            ...
            <h2 id="mh-services-title" className="mh-carousel-title">{currentSlide.title}</h2>
            <p className="mh-carousel-text">{currentSlide.text}</p>
            <div className="mh-carousel-controls">
              <button type="button" className="mh-carousel-btn" onClick={() => moveSlide(-1)} aria-label="Anterior">‹</button>
              ...
              <button type="button" className="mh-carousel-btn" onClick={() => moveSlide(1)} aria-label="Siguiente">›</button>
            </div>
          </div>
        </article>
        ...
        <aside className="mh-help-panel">
          <div className="mh-help-body">
            ...
            <p className="mh-help-text">
              Elegí el profesional que mejor se adapte a tus necesidades y reservá tu horario en pocos minutos.</p>
          ...
          <button type="button" className="mh-help-btn">Solicitar agenda</button>
        </aside>
      </div>
      ...
      <div className="mh-grid-heading">
        <div>
          ...
          <h2 className="mh-sidebar-title">Perfiles disponibles</h2></div>
        <p className="mh-result-count">{filteredProfessionals.length} resultado{filteredProfessionals.length !== 1 ? 's' : ''}</p>
      </div>


      <div className="mh-grid">
        {filteredProfessionals.map((professional) => (
          <article key={`${professional.name}-${professional.schedule}`} className="mh-card">
            ...
            <div className="mh-card-horizontal">
              <div className="mh-profile-media">
                ...
                <div className="mh-photo-meta">
                  <span className="mh-card-price">${professional.price.toLocaleString('es-UY')}</span>
                  <span className="mh-consultation-note">Online o presencial</span>
                </div>
              </div>
              <div className="mh-card-info">
                ...
                <div className="mh-therapy-list" aria-label={`Tipos de terapia de ${professional.name}`}>
            ...
            <div className="mh-card-footer">
              <div className="mh-card-calendar" aria-label={`Calendario para agendar con ${professional.name}`}>
                <p className="mh-calendar-label">{getSelectedDateLabel(selectedDates[professional.name])}</p>
                <DayPicker
                  mode="single"
                  selected={selectedDates[professional.name]}
                  onSelect={(date) => selectProfessionalDate(professional.name, date)}
                  locale={es}
                  weekStartsOn={1}
                  showOutsideDays/>
              </div>
              <button
                ...
                onClick={() => confirmProfessionalAppointment(professional.name)}>Agendar</button>
            </div>
          </article>
        ))}
      </div>
      ...
      {confirmedAppointment && (
        <div
          ...
          <div
            ...
            <p>
              La {confirmedAppointment.professionalName} se pondrá en contacto contigo a la brevedad, te esperamos el{' '}
              <strong>{getSelectedDateLabel(confirmedAppointment.date)}</strong>.
            </p>
            <button
              type="button"
              className="mh-confirmation-btn"
              onClick={() => setConfirmedAppointment(null)}>Confirmar</button>
          </div>
        </div>
      )}
    </section>
